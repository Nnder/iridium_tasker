        ...
        reply_markup:
            {
                inline_keyboard: [
                    [
                        ...
                        { text: "Не полный день", web_app: {url: `${webAppUrl}/time.html?user=${chat_id}&task=${task.id}&mid=${message_id}`}}
                    ],
                ]
            }
    };

    await bot.editMessageReplyMarkup(fullDay.reply_markup, {chat_id, message_id})
